...
# append new BLS data extension to the output file
    ...
    if status == 0:
        ...
        instr[-1].header.ascardlist()['TTYPE1'].comment = 'column title: trial period'
        instr[-1].header.ascardlist()['TTYPE2'].comment = 'column title: trial mid-transit zero-point'
        instr[-1].header.ascardlist()['TTYPE3'].comment = 'column title: trial transit duration'
        instr[-1].header.ascardlist()['TTYPE4'].comment = 'column title: normalized signal residue'
        instr[-1].header.ascardlist()['TFORM1'].comment = 'column type: float32'
        instr[-1].header.ascardlist()['TFORM2'].comment = 'column type: float64'
        instr[-1].header.ascardlist()['TFORM3'].comment = 'column type: float32'
        instr[-1].header.ascardlist()['TFORM4'].comment = 'column type: float32'
        instr[-1].header.ascardlist()['TUNIT1'].comment = 'column units: days'
        instr[-1].header.ascardlist()['TUNIT2'].comment = 'column units: BJD - 2454833'
        instr[-1].header.ascardlist()['TUNIT3'].comment = 'column units: hours'
