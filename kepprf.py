...
# plot style
    ...
    if status == 0:
        ...
        pylab.clf()
        plotimage(imgdat_pl,zminfl,zmaxfl,1,row,column,xdim,ydim,0.06,0.52,'observation',colmap)
...
#        plotimage(imgprf_pl,0.0,zmaxpr/0.5,2,row,column,xdim,ydim,0.52,0.52,'model',colmap)
        ...
        kepplot.borders(maskimg,xdim,ydim,pixcoord1,pixcoord2,1,'w','--',0.5)
        kepplot.borders(maskimg,xdim,ydim,pixcoord1,pixcoord2,2,'w','-',3.0)
...
# plot the image window
    ...
    pylab.text(0.05, 0.93,tlabel,horizontalalignment='left',verticalalignment='center',
               fontsize=28,fontweight=500,color='w',transform=ax.transAxes)
