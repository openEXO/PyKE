    ...
    if status == 0 and cmdLine:
        ...
        for i in range(int(nincl/50) + 1):
            ...
            args = itertools.izip(fluxp,errp,itertools.repeat(DATx),itertools.repeat(DATy),
                                  ...
                                  itertools.repeat(numpy.arange(cad1,nincl)[-1]),itertools.repeat(float(x[0])),
...
# construct output light curve extension
            ...
            col6 = Column(name='PSF_BKG',format='E',unit='e-/s',array=opsf_bkg)
            ...
            col12 = Column(name='PSF_FOCUS1',format='E',unit='e-/s',array=opsf_focus1)
            col13 = Column(name='PSF_FOCUS2',format='E',unit='e-/s',array=opsf_focus2)
