...
"""
Name: kepextract.py
Written by: Martin Still and Tom Barclay
Date released: July 27 2011

Changelog:
1.0 released
3.0 made it possible to run from the command line if there are arguements given to the call to kepextract
"""

# global variables

def kepextract(infile,maskfile,outfile,clobber,verbose,logfile,status): 
...
if '--shell' in sys.argv:
    ...
    kepextract(args.infile,args.maskfile,args.outfile, args.clobber, args.verbose, args.logfile, args.status)
